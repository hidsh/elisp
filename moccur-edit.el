...
;;  $Id: moccur-edit.el,v 2.2 2004/10/14 14:12:28 akihisa Exp $
...
(defvar moccur-edit-reject-overlays nil)
...
(defun moccur-edit-put-reject-face ()
  (let ((ov))
    (beginning-of-line)
    (re-search-forward "^[ ]*[0-9]+ " nil t)
    (setq ov (make-overlay (point) (line-end-position)))
    (overlay-put ov 'moccur-edit t)
    (overlay-put ov 'face 'moccur-edit-reject-face)
    (overlay-put ov 'priority 0)
    (setq moccur-edit-reject-overlays (cons ov moccur-edit-reject-overlays))
    ))
