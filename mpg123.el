...
;;; $Id: mpg123.el,v 1.40 2003/07/26 04:23:27 yuuji Exp yuuji $
;;; Last modified Wed Oct 22 23:04:02 2003 on firestorm
;;; Update count: 1133
  ...
  (if (or (not (looking-at "[0-9]"))
	...
	(let ((time (buffer-substring
	  ...
	  (let ((frames (mpg123:get-music-info mpg123*cur-music-number 'frames))
	    ...
	    (overlay-put (setq mpg123*indicator-overlay
			       (make-overlay
				istart (+ (mpg123:window-width) -1 istart)))
			 'face
