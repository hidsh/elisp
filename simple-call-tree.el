...
;; additional function for view
;; http://www.emacswiki.org/cgi-bin/wiki.pl?action=browse;oldid=CallTree;id=SimpleCallTree
;; To show a pretty-printed representation of functions and their
;; callers, you could use something like:
