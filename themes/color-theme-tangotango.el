...
(defun color-theme-tangotango ()
  ...
  (color-theme-install
   '(color-theme-tangotango
     ...
     (cursor ((t (:background "white" :foreground "#222222"))))
     ;; (highlight ((t (:background "brown4" :foreground nil))))
     (highlight ((t (:background "grey25" :foreground nil))))
     (border ((t (:background "#888a85"))))
     ;; (fringe ((t (:background "grey10"))))
     (fringe ((t (:background "grey10" :foreground "white"))))
     ...
     (isearch ((t (:background "orange" :foreground "#2e3436"))))
